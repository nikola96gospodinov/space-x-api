...
export default function Starship ({ rocket }) {
            ...
            <div>
                <div class={style.stats}>
                    <div>
                        ...
                        {
                            rocket.first_stage.burn_time_sec === null
                            ? <span>N/A</span>
                            : <span>{rocket.first_stage.burn_time_sec} sec</span>
                        }
                    </div>
                    <div>
            ...
            <div>
                <div class={style.stats}>
                    <div>
                        <strong>Burn Time: </strong>
                        {
                            rocket.second_stage.burn_time_sec === null
                            ? <span>N/A</span>
                            : <span>{rocket.second_stage.burn_time_sec} sec</span>
                        }
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        {
                            rocket.second_stage.payloads.composite_fairing.diameter.meters === null
                            ? <span>N/A</span>
                            : <span>{rocket.second_stage.payloads.composite_fairing.diameter.meters}m<span> / {rocket.second_stage.payloads.composite_fairing.diameter.feet}ft</span></span>
                        }
                    </div>
                    <div>
                        <strong>Fairing Height: </strong>
                        {
                            rocket.second_stage.payloads.composite_fairing.height.meters === null
                            ? <span>N/A</span>
                            : <span>{rocket.second_stage.payloads.composite_fairing.height.meters}m<span> / {rocket.second_stage.payloads.composite_fairing.height.feet}ft</span></span>
                        }
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <SEO 
                title={rocket.name} 
                description={getFirstSentence(rocket.description)}
                index="index"
                follow="follow"
            />
            <Layout>
                <div className={style.StarshipBanner}>
                    <div className="container banner-container">
                        <div className="double-grid">
                            <div>
                                <h1>{rocket.name}</h1>
                                <h2>{getFirstSentence(rocket.description)}</h2>
                ...
                <div id="info" className={style.info}>
                    <div className="container">
                        <div className={style.rocketGrid2}>
